...
_Generated: 2026-08-30T19:09:53.817Z_
...
Workspace `mcp.json` _(folder: AI-Automation-Projects)_

- **d:\ai_3x_qa\AI-Automation-Projects\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\AMITH\AppData\Roaming\Code\User\mcp.json** — _File missing_
